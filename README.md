...
- **[Donggurami (USW-Circle-Link)](https://github.com/USW-Circle-Link/USW-Circle-Link-APP)** - Flutter와 MVVM 아키텍처를 사용하여 커뮤니티 플랫폼을 구축하는 프론트엔드 팀 리드
- **[USW-AI-Security](https://github.com/Woochang4862/USW-AI-Security)** - AI 시스템을 위한 보안 연구 및 구현
- **[Soon](https://github.com/Woochang4862/Soon)** - 복잡한 데이터 상호작용과 실시간 기능을 포함하는 서버 사이드 프로젝트
- **[ETF Trading Project](https://github.com/Woochang4862/etf-trading-project)** - 자동화된 트레이딩 전략 및 데이터 분석 파이프라인 개발
